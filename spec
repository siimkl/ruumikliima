...
* 7 päeva mõõtmist kodus;
* sama pakiga tagastus pakiautomaadist;
* andmete analüüs ja raport pärast tagastust.

Teenuse peamine lubadus:

**Võta mõõtekit pakiautomaadist, vajuta seade ühe nupuga 7 päevaks käima, tagasta sama pakiga ja saa raport.**
...
4. Klient võtab paki vastu, paigutab seadmed juhendi järgi ja käivitab need ühe nupuga.
...
* pakiautomaadi teenuse ja asukoha valik;
* soovitud saabumiskuupäev;
